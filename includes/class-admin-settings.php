	...
	public function render_settings_page() {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				<p class="description"><?php esc_html_e( 'Merge tags: {name} {email} {phone} {company} {address} {tier} {points_included} {template} {domain} {solutions} {points_used} {points_shortfall} {page_url} — plus, from "Build Your Business" submissions: {domain_wanted} {marketing_tier} {licenses} {measure_tier} {measure_addons} {bespoke_selected} {bespoke_interest} {enterprise_selected} {pay_annually}', 'strivre-solutions-wizard' ); ?></p>
				<table class="form-table" role="presentation">
					<tr>
